...
Create new project → paste apps_script.js code

Run setupSheets() once manually

Copy the Admin Secret Key shown

Deploy as Web App → Anyone → copy URL

Step 2 — Admin Panel
Open your portal URL

Click "Admin Panel" → password: Alibaloch-IU

Go to Settings → paste Apps Script URL + Admin Secret Key

Upload questions via Word import or manually
